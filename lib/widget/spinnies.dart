...
class NougatAnimation extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(color: Color(0xFF131628)),
        child: Center(
          child: SizedBox(
            width: 200,
            height: 200,
...
class Spinnies extends StatefulWidget {
  ...
  Spinnies({
    ...
    List<SpinRect> rects,
            ...
            [
              SpinRect(color: Color(0x10ffffff), begin: 0.0, end: 1.0),
              SpinRect(color: Color(0x30ffffff), begin: 0.0, end: 0.5),
              SpinRect(color: Color(0x50ffffff), begin: 0.25, end: 1.25),
              SpinRect(color: Color(0x70ffffff), begin: 0.5, end: 1.5),
              SpinRect(color: Color(0x90ffffff), begin: 0.75, end: 1.75),
            ],
        super(key: key);
...
class SpinniesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.saveLayer(null, tmpPaint);
  ...
  bool shouldRepaint(SpinniesPainter oldDelegate) {
    return oldDelegate.blendMode != this.blendMode ||
        oldDelegate.rects != this.rects;
  }
